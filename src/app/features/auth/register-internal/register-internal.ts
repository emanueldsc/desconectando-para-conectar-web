...
@Component({
  selector: 'register-internal',
  imports: [ReactiveFormsModule, RouterLink],
  templateUrl: './register-internal.html',
  styleUrl: './register-internal.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class RegisterInternal {
  ...
  protected submit(): void {
    ...
    this.authApi.registerInternal(payload)
      .pipe(
  ...
  private handleRegisterResponse(response: RegisterResponseType): void {
    ...
    this.apiFeedback.set({
      text: `${response.message} O acesso pode ser feito pela area de login.`,
      isError: false,
    });
  ...
  private extractApiErrorMessage(error: unknown): string {
    ...
    return 'Nao foi possivel concluir o cadastro interno agora. Tente novamente.';
  }
}
